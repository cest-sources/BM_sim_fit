...
Sim.B1            =     3.2;                 % standard B1 value in µT
Sim.Trec          =     3;                  % standard recover time in s
...
if Sim.pulsed       
    Sim.n     = 1;              % number of saturation pulses
...
% settings for TTM pulses
Sim.TTM_rep         = 0;                  % 0 = no TTM, 1 = every pulse, 2 = every second pulse ...
% Sim.TTM_pulseshape  = 'block_ttm';        % cases: block_ttm ... unused up to now
% Sim.TTM_bandwidth   = 3;                  % bandwidth of the TTM pulses in ppm
% Sim.TTM_B1          = 8;                  % B1 amplitude of the TTM pulses in µT
% Sim.TTM_type        = [1 -3 3 -1];        % settings for phase (+-) and amplitude of the TTMs: [1 -3 3 -1]
% Sim.TTM_occurance   = 1;                  % >= 1 ... how often shall the TTM puls take place before EACH CEST-saturation part
